...
public class LocalStorageHelper extends DocumentsProvider {
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        row.add(DocumentsContract.Root.COLUMN_TITLE, Objects.requireNonNull(getContext()).getString(R.string.internal_storage));
    ...
    public String createDocument(final String parentDocumentId, final String mimeType,
        ...
        try {
            ...
            Log.e(LocalStorageHelper.class.getSimpleName(), "Error creating new file " + newFile);
        }
        return null;
    }
    ...
    public AssetFileDescriptor openDocumentThumbnail(final String documentId, final Point sizeHint,
        ...
        try {
            ...
            Log.e(LocalStorageHelper.class.getSimpleName(), "Error writing thumbnail", e);
            return null;
        } finally {
            if (out != null)
                try {
                    ...
                    Log.e(LocalStorageHelper.class.getSimpleName(), "Error closing thumbnail", e);
                }
        }
